...
diffCToAB = 20
```
**NB:** The ***miss*** is obtained from `(c^n - (a^n + b^n))`. This is the value we will check for each integer triplet against the ***maxMiss*** value before the triplet qualifies as a ***near-miss***.
## Step 3
